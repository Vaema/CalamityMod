...
namespace CalamityMod.Dusts
{
    public class VoidDust : ModDust
    {
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            Main.spriteBatch.Draw(SolidCircle.Value, dust.position - Main.screenPosition, null, Color.Black * Utils.GetLerpValue(255, 0, dust.alpha), dust.rotation, SolidCircle.Size() * 0.5f, dust.scale * 0.075f, SpriteEffects.None, 0);
            return false;
        }
    }
