...
{
    public class BasaltGullyLavaSplash : ModDust
    {
        ...
        public override bool Update(Dust dust)
        {
            ...
            if (dust.noGravity)
            {
                ...
                Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f + 1f), num109 * (2.5f / 4), num109 * (1.3f / 4), num109 * (0.1f / 4));
            }
            else
            {
                ...
                Lighting.AddLight((int)(dust.position.X / 16f), (int)(dust.position.Y / 16f), num3 * (2.5f / 4), num3 * (1.3f / 4), num3 * (0.1f / 4));
            }
