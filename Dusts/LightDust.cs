...
namespace CalamityMod.Dusts
{
    public class LightDust : ModDust
    {
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            Main.EntitySpriteDraw(rechargeTexture2, dustCenter - Main.screenPosition, null, Color.Lerp(dust.color, Color.White, 0.3f) with { A = 0 } * Utils.GetLerpValue(255, 0, dust.alpha), dust.rotation, rechargeTexture2.Size() * 0.5f, dust.scale * 0.075f, SpriteEffects.None, 0);
            return false;
        }
    }
}
