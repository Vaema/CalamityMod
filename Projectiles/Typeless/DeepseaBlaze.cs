...
public class DeepseaBlaze : ModProjectile, ILocalizedModType
{
    ...
    public override void AI()
    {
        ...
        while ((float)timerCounter < projTimer)
        {
            ...
            rand1 *= randAdjust;
            rand2 *= randAdjust;
            int fiery = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Flare, 0f, 0f, 100, default, 1.5f);
