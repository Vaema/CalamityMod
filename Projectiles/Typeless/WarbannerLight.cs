...
namespace CalamityMod.Projectiles.Typeless
{
    public class WarbannerLight : ModProjectile, ILocalizedModType
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            {
                float bScale2 = 0.75f;
                Main.EntitySpriteDraw(bTexture, Owner.Center - Main.screenPosition, null, Color.Lerp(drawColor, Color.White, i * 0.15f) with { A = 0 }, 0, bTexture.Size() * 0.5f, (bScale2 - i * 0.15f) * rot2, SpriteEffects.None, 0);
            }

            Main.EntitySpriteDraw(rTexture, Owner.Center - Main.screenPosition, null, drawColor with { A = 0 }, Main.rand.NextFloat(-2, 2), rTexture.Size() * 0.5f, 0.03f * rot2, SpriteEffects.None, 0);
            Main.EntitySpriteDraw(rTexture, Owner.Center - Main.screenPosition, null, drawColor with { A = 0 }, Main.rand.NextFloat(-2, 2), rTexture.Size() * 0.5f, 0.04f * rot2, SpriteEffects.None, 0);
            return false;
        }
