...
namespace CalamityMod.Projectiles.Typeless
{
    public class Luxor : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            fxFade = (float)Math.Pow(Utils.GetLerpValue(30, 0, attackTimer, true), 3) + postFireBoost;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float idleFade = (float)Math.Pow(Utils.GetLerpValue(280, 300, idleTimer, true), 5);
