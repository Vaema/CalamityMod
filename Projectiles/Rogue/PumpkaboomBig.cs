...
namespace CalamityMod.Projectiles.Rogue
{
    ...
    public class PumpkaboomBig : ModProjectile, ILocalizedModType
    {
        ...
        public override string Texture => "CalamityMod/Projectiles/Rogue/PumpkaboomUnlit";
...
                    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("CalamityMod/Sounds/Item/PumpkaboomStealthTicking") with { Pitch = 0f, Volume = 1f, MaxInstances = 2 }, Projectile.Center);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.ai[1] != 1)
            {
                ...
                Particle blastRing2 = new CustomPulse(spawnPos, Vector2.Zero, c1 * 0.6f, "CalamityMod/Particles/HighResHollowCircleHardEdge", Vector2.One, Main.rand.NextFloat(-10, 10), 0.07f, scale * 2f, 11);
