    ...
    public class SeafoamBombProj : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < (Projectile.Calamity().stealthStrike ? 5 : 1); i++)
            {
                ...
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), posX, posY, 0f, 0f, ModContent.ProjectileType<SeafoamBubble>(), (int)(Projectile.damage * 0.4), 0f, Projectile.owner, 0f, 0f);
            }
