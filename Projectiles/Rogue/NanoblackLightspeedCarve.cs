    ...
    public class NanoblackLightspeedCarve : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (ProgressiveState == ProgressiveState_Initial)
            {
                ...
                if (VisibleCarveLength < distToTarget || VisibleCarveLength > distToTarget + maxOvershoot)
                {
                    float randomOvershoot = Main.rand.NextFloat(minOvershoot, maxOvershoot);
                    VisibleCarveLength = distToTarget + randomOvershoot;
                }
            ...
            Vector2 beamDims = new(VisibleCarveLength, Projectile.width * Projectile.scale);
            ...
            Vector2 lightDest = Projectile.Center + fakeVel * VisibleCarveLength;
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            float _ = float.NaN;
            Vector2 fakeVel = (TargetPos - Projectile.Center).SafeNormalize(-Vector2.UnitY);
            Vector2 endPoint = Projectile.Center + fakeVel * VisibleCarveLength;
        ...
        private void CarveEffects()
        {
            ...
            Particle carveParticle = new StaticGlowLine(segmentStart, segmentEnd, particleVel, lifetime, xScale, xShrink, NanoblackReaper.LightspeedCarveColor, true);
