...
namespace CalamityMod.Projectiles.Boss
{
    public class MushBombFall : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            float velocityYLimit = Projectile.ai[0] == 1f ? 3f : BossRushEvent.BossRushActive ? 12f : CalamityWorld.death ? 6f : 5f;
            float velocityYIncrement = Projectile.ai[0] == 1f ? 0.15f : BossRushEvent.BossRushActive ? 0.24f : CalamityWorld.death ? 0.12f : 0.1f;
