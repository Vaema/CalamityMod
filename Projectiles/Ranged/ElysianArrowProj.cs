...
namespace CalamityMod.Projectiles.Ranged
{
    public class ElysianArrowProj : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), spawnSpot, velocity, ModContent.ProjectileType<ElysianArrowRain>(), (int)(Projectile.damage * 0.20f), 0f, Projectile.owner, 0f, 0f);
