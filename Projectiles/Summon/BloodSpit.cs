...
namespace CalamityMod.Projectiles.Summon
{
    public class BloodSpit : ModProjectile, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.Calamity().BloodstoneOrbValue = 1; //Bloodstone Orb lifesteal. May want to go back to regular lifesteal.
        }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            //regular lifesteal code. Not sure if we wanna go back to it so I left it here.
