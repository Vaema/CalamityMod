...
namespace CalamityMod.Projectiles.Summon
{
    public class PlantationStaffSeed : ModProjectile, ILocalizedModType
    {
        ...
        {
            Texture2D texture = (RandomTexture == 0f) ? Terraria.GameContent.TextureAssets.Projectile[Type].Value : ModContent.Request<Texture2D>("CalamityMod/Projectiles/Summon/PlantationStaffSeed2").Value;
