    ...
    public partial class CalamityGlobalProjectile : GlobalProjectile
    {
        ...
        internal static void LoadTweaks()
        {
            ...
            currentTweaks = new SortedDictionary<int, IProjectileTweak[]>
            {
                ...
                { ProjectileID.Arkhalis, Do(TrueMeleeNoSpeed, ScaleExact(1.25f), IDStaticIFrames(5)) },
                ...
                { ProjectileID.ExplosiveBullet, Do(PointBlank, ExtraUpdatesDelta(+2), IDStaticIFrames(5)) },
                ...
                { ProjectileID.InfluxWaver, Do(ExtraUpdatesExact(1), DefaultIDStaticIFrames) },
                ...
                { ProjectileID.Terragrim, Do(TrueMeleeNoSpeed, ScaleExact(1.25f), IDStaticIFrames(5)) },
                ...
                { ProjectileID.PiercingStarlight, Do(TrueMelee, IDStaticIFrames(4)) },
                ...
                { ProjectileID.CandyCorn, Do(PointBlank, IDStaticIFrames(7)) },
                ...
                {ProjectileID.Hook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BallofFire, Do(DefaultIDStaticIFrames)},
                {ProjectileID.MagicMissile, Do(IDStaticIFrames(8))},
                {ProjectileID.DirtBall, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ShadowOrb, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.IvyWhip, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.BlueFairy, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DualHookBlue, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DualHookRed, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.PinkFairy, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GreenFairy, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.Penguin, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.Turtle, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.BeachBall, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.BabyEater, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.BabySkeletronHead, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabyHornet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.TikiSpirit, Do(DefaultIDStaticIFrames)},
                {ProjectileID.PetLizard, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Leaf, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Parrot, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Truffle, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Sapling, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.GemHookAmethyst, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GemHookTopaz, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GemHookSapphire, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GemHookEmerald, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GemHookRuby, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GemHookDiamond, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabyDino, Do(DefaultIDStaticIFrames)},
                {ProjectileID.CrimsandBallFalling, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Stynger, Do(IDStaticIFrames(7))},
                ...
                {ProjectileID.SkeletronHand, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.EyeSpring, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabySnowman, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.Squashling, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BatHook, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.WoodHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.CursedSapling, Do(DefaultIDStaticIFrames)},
                {ProjectileID.StarAnise, Do(DefaultIDStaticIFrames)},
                {ProjectileID.CandyCaneHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ChristmasHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Puppy, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.BabyGrinch, Do(DefaultIDStaticIFrames)},
                {ProjectileID.LovePotion, Do(DefaultIDStaticIFrames)},
                {ProjectileID.FoulPotion, Do(DefaultIDStaticIFrames)},
                {ProjectileID.FishHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.HornetStinger, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SpiderEgg, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabySpider, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ZephyrFish, Do(DefaultIDStaticIFrames)},
                {ProjectileID.MiniRetinaLaser, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SlimeHook, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.Meteor1, Do(IDStaticIFrames(5))},
                {ProjectileID.Meteor2, Do(IDStaticIFrames(5))},
                {ProjectileID.Meteor3, Do(IDStaticIFrames(5))},
                ...
                {ProjectileID.Electrosphere, Do(IDStaticIFrames(8))},
                {ProjectileID.Xenopopper, Do(DefaultIDStaticIFrames)},
                {ProjectileID.AntiGravityHook, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.TendonHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ThornHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.IlluminantHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.WormHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.MagicLantern, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ShadowFlameKnife, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabyFaceMonster, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.NailFriendly, Do(IDStaticIFrames(1))},
                ...
                {ProjectileID.MechanicWrench, Do(IDStaticIFrames(7))},
                ...
                {ProjectileID.PortalGun, Do(DefaultIDStaticIFrames)},
                {ProjectileID.PortalGunBolt, Do(DefaultIDStaticIFrames)},
                {ProjectileID.PortalGunGate, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.LastPrismLaser, Do(IDStaticIFrames(5))},
                {ProjectileID.LastPrism, Do(DefaultIDStaticIFrames)},
                {ProjectileID.NebulaBlaze1, Do(IDStaticIFrames(5))},
                {ProjectileID.NebulaBlaze2, Do(IDStaticIFrames(5))},
                {ProjectileID.Daybreak, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BouncyDynamite, Do(DefaultIDStaticIFrames)},
                {ProjectileID.LunarHookSolar, Do(DefaultIDStaticIFrames)},
                {ProjectileID.LunarHookVortex, Do(DefaultIDStaticIFrames)},
                {ProjectileID.LunarHookNebula, Do(DefaultIDStaticIFrames)},
                {ProjectileID.LunarHookStardust, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SuspiciousTentacle, Do(DefaultIDStaticIFrames)},
                {ProjectileID.WireKite, Do(DefaultIDStaticIFrames)},
                {ProjectileID.StaticHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.CompanionCube, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GeyserTrap, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BeeHive, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SpiritFlame, Do(IDStaticIFrames(5))},
                {ProjectileID.SkyFracture, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Ale, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2ExplosiveTrapT1, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2ExplosiveTrapT2, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2ExplosiveTrapT3, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2PetDragon, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2PetGhost, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2PetGato, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.DirtGolfBall, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.GolfBallDyedBlack, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedBlue, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedBrown, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedCyan, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedGreen, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedLimeGreen, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedOrange, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedPink, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedPurple, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedRed, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedSkyBlue, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedTeal, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedViolet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolfBallDyedYellow, Do(DefaultIDStaticIFrames)},
                {ProjectileID.AmberHook, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.UpbeatStar, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SugarGlider, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Geode, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ScarabBomb, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SharkPup, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.LilHarpy, Do(DefaultIDStaticIFrames)},
                {ProjectileID.FennecFox, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GlitteryButterfly, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BloodArrow, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ChumBucket, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabyImp, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabyRedPanda, Do(DefaultIDStaticIFrames)},
                {ProjectileID.StormTigerGem, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BookOfSkullsSkull, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Plantero, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DynamiteKitten, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BabyWerewolf, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ShadowMimic, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Football, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.SquirrelHook, Do(DefaultIDStaticIFrames)},
                {ProjectileID.TreeGlobe, Do(DefaultIDStaticIFrames)},
                {ProjectileID.WorldGlobe, Do(DefaultIDStaticIFrames)},
                {ProjectileID.VoltBunny, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ZapinatorLaser, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ZoologistStrikeGreen, Do(DefaultIDStaticIFrames)},
                {ProjectileID.KingSlimePet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.EyeOfCthulhuPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.EaterOfWorldsPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BrainOfCthulhuPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SkeletronPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.QueenBeePet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DestroyerPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.TwinsPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.SkeletronPrimePet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.PlanteraPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GolemPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DukeFishronPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.LunaticCultistPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.MoonLordPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.FairyQueenPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.PumpkingPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.EverscreamPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.IceQueenPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.MartianPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2OgrePet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DD2BetsyPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.CombatWrench, Do(IDStaticIFrames(7))},
                ...
                {ProjectileID.QueenSlimePet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.QueenSlimeHook, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.BerniePet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.GlommerPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.DeerclopsPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.PigPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.ChesterPet, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.JunimoPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.JuminoStardropAnimation, Do(DefaultIDStaticIFrames)},
                {ProjectileID.MoonGlobe, Do(DefaultIDStaticIFrames)},
                {ProjectileID.BlueChickenPet, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Spiffo, Do(DefaultIDStaticIFrames)},
                ...
                {ProjectileID.DirtiestBlock, Do(DefaultIDStaticIFrames)},
                {ProjectileID.Fertilizer, Do(DefaultIDStaticIFrames)},
                {ProjectileID.JimsDrone, Do(DefaultIDStaticIFrames)},
