...
{
    public class IgnisSigilEmbers : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            GeneralParticleHandler.SpawnParticle(new GlowOrbParticle(Projectile.Center, Projectile.velocity, false, 2, Projectile.scale * 1.45f, Color.Salmon));
