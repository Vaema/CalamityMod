...
            Projectile.penetrate = -1;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile explosion = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center + (new Vector2(-26, 0).RotatedBy(Projectile.rotation - MathHelper.PiOver2)), Vector2.Zero, ModContent.ProjectileType<AquaSigilWaterballExplosion>(), (int)(Projectile.damage * 3.85f), Projectile.knockBack, Projectile.owner);
                explosion.ai[1] = 260f;
