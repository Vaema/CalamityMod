...
{
    public class AerSigil : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[2] > 0)
            {
                ...
                {
                    SoundEngine.PlaySound(new("CalamityMod/Sounds/Item/VividClarityBeamAppear") { Volume = 0.5f, PitchVariance = 0.1f }, Projectile.Center);
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, targetDirection * 48f, ModContent.ProjectileType<AerSigilMissile>(), Projectile.damage * 2, Projectile.knockBack, Projectile.owner);
                }
