...
namespace CalamityMod.Projectiles.Melee
{
    public class EmpyreanKnife : ModProjectile, ILocalizedModType
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) => Main.player[Projectile.owner].SpawnLifeStealProjectile(target, Projectile, ProjectileID.VampireHeal, (int)Math.Round(hit.Damage * 0.015));
