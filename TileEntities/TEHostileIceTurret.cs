...
namespace CalamityMod.TileEntities
{
    public class TEHostileIceTurret : TEBaseTurret
    {
        ...
        public override int HostTileWidth => HostileIceTurret.Width;
        public override int HostTileHeight => HostileIceTurret.Height;

        // Projectile variables
        public override int ProjectileType => ModContent.ProjectileType<IceShotBuffer>();
        public override int ProjectileDamage => Main.expertMode ? 18 : 24;
