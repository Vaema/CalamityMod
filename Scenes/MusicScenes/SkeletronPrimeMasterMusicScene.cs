...
namespace CalamityMod.Systems
{
    public class SkeletronPrimeMasterMusicScene : ModSceneEffect
    {
        ...
        public override bool IsSceneEffectActive(Player player) => CalamityWorld.death && NPC.AnyNPCs(NPCID.SkeletronPrime) && Main.npc[NPC.FindFirstNPC(NPCID.SkeletronPrime)].Distance(player.Center) <= 525f * 16f;
    }
}
