...
public class SilvaRevive : CooldownHandler
{
    ...
    public override Color OutlineColor => new(151, 211, 152);
    public override Color CooldownStartColor => new(226, 188, 74);
    public override Color CooldownEndColor => new(151, 211, 152);
