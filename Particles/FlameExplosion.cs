...
{
    public class FlameExplosion : Particle
    {
        public override string Texture => "CalamityMod/Particles/FlameExplosion";
        ...
        public FlameExplosion(Vector2 position, Vector2 velocity, Color color, Vector2 squish, float rotation, float originalScale, float finalScale, int lifeTime, float opacity)
        {
            Position = position;
            Velocity = velocity;
            BaseColor = color;
