    ...
    public class Shred : ModBuff
    {
        ...
        internal static void DrawEffects(NPC npc, CalamityGlobalNPC cgn, ref Color drawColor)
        {
            ...
            for (int i = 0; i < exactBloodCount; ++i)
            {
                ...
                bloodColor = (!ChildSafety.Disabled ? Main.DiscoColor : Color.Lerp(bloodColor, new Color(51, 22, 94), Main.rand.NextFloat(0.65f)));
            ...
            for (int i = 0; i < exactBloodCount / 3; ++i)
            {
                ...
                Color bloodColor = (!ChildSafety.Disabled ? Main.DiscoColor : Color.Lerp(Color.Red, Color.DarkRed, Main.rand.NextFloat(0.5f, 1f)));
