...
namespace CalamityMod.Tiles.Pylons
{
    ...
    public class CragsPylonTile : BasePylonTile
    {
        ...
        public override bool ValidTeleportCheck_BiomeRequirements(TeleportPylonInfo pylonInfo, SceneMetrics sceneData) => BiomeTileCounterSystem.BrimstoneCragTiles >= 150;
    }
}
