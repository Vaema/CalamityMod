...
public class SilvaChest : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurnitureSilva.SilvaChest>(), FurnitureCommon.GetMapChestName);
    }
    ...
    public override void MouseOver(int i, int j) => FurnitureCommon.ChestMouseOver<Items.Placeables.FurnitureSilva.SilvaChest>(i, j);
    public override void MouseOverFar(int i, int j) => FurnitureCommon.ChestMouseFar<Items.Placeables.FurnitureSilva.SilvaChest>(i, j);
