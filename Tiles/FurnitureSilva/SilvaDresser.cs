...
namespace CalamityMod.Tiles.FurnitureSilva
{
    public class SilvaDresser : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurnitureSilva.SilvaDresser>(), FurnitureCommon.GetMapChestName);
        }
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.DresserMouseOver<Items.Placeables.FurnitureSilva.SilvaDresser>();
        public override void MouseOverFar(int i, int j) => FurnitureCommon.DresserMouseFar<Items.Placeables.FurnitureSilva.SilvaDresser>();
