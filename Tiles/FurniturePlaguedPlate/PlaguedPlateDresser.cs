...
namespace CalamityMod.Tiles.FurniturePlaguedPlate
{
    public class PlaguedPlateDresser : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurniturePlagued.PlaguedPlateDresser>(), FurnitureCommon.GetMapChestName);
        }
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.DresserMouseOver<Items.Placeables.FurniturePlagued.PlaguedPlateDresser>();
        public override void MouseOverFar(int i, int j) => FurnitureCommon.DresserMouseFar<Items.Placeables.FurniturePlagued.PlaguedPlateDresser>();
