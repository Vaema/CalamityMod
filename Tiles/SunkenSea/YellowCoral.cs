...
namespace CalamityMod.Tiles.SunkenSea
{
    public class YellowCoral : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DustType = 119;
            AddMapEntry(new Color(198, 169, 24));
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            Color Yellow1 = new Color(218, 203, 67);
            Color Yellow2 = new Color(121, 76, 1);
            Color value = Color.Lerp(Yellow1, Yellow2, (MathF.Sin(-j / 80f + Main.GameUpdateCount * 0.017f + i / 40f) + 1f) / 2f);
            Color value1 = Color.Lerp(Yellow1, Yellow2, (MathF.Sin((j - 100) / 50f + Main.GameUpdateCount * 0.004f + -i / 30f) + 1f) / 2f);
