...
namespace CalamityMod.Tiles.SunkenSea
{
    public class RefractivePrismTorch : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Items.Placeables.Furniture.RefractivePrismTorch>();
        }
        ...
        {
            CalamityUtils.DrawFlameEffect(ModContent.Request<Texture2D>("CalamityMod/Tiles/SunkenSea/RefractivePrismTorchFlame").Value, i, j, 2);
        }
