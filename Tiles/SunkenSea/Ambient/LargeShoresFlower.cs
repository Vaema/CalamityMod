...
namespace CalamityMod.Tiles.SunkenSea.Ambient
{
    public class LargeShoresFlower : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/SunkenSea/Ambient/LargeShoresFlower").Value;
            ...
            CalamityUtils.DrawFlameEffect(ModContent.Request<Texture2D>("CalamityMod/Tiles/SunkenSea/Ambient/LargeShoresFlower_Center").Value, i, j, 2);
        }
    }
}
