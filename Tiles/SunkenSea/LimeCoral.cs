...
namespace CalamityMod.Tiles.SunkenSea
{
    public class LimeCoral : ModTile
    {
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            Color Lime1 = new Color(176, 242, 96);
            Color Lime2 = new Color(82, 113, 29);
            Color value = Color.Lerp(Lime1, Lime2, (MathF.Sin(-j / 80f + Main.GameUpdateCount * 0.017f + i / 40f) + 1f) / 2f);
            Color value1 = Color.Lerp(Lime1, Lime2, (MathF.Sin((j - 100) / 50f + Main.GameUpdateCount * 0.004f + -i / 30f) + 1f) / 2f);
