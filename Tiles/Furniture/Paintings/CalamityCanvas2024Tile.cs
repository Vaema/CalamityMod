...
namespace CalamityMod.Tiles.Furniture.Paintings
{
    ...
    public class CalamityCanvas2024Tile : ModTile
    {
        ...
        {
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<Items.Placeables.Furniture.Paintings.CalamityCanvas2024>();
        ...
        {
            var texture = CalamityCanvas2023Tile.border.Value;
            var cornerTex = CalamityCanvas2023Tile.corner.Value;
            var canvasID = (ushort)ModContent.TileType<CalamityCanvas2024Tile>();
            var commonDim = 8;
            var finalCord = 72;
            var size = 80;
