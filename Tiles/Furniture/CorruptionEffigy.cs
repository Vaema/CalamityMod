...
public class CorruptionEffigy : ModTile
{
    ...
    public override bool RightClick(int i, int j)
    {
        ...
        // Forcibly remove Crimson Effigy's buff.
        p.ClearBuff(ModContent.BuffType<CrimsonEffigyBuff>());

        // 108000 is the duration used by Ammo Box.
        p.AddBuff(ModContent.BuffType<CorruptionEffigyBuff>(), 108000);
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<Items.Placeables.Furniture.CorruptionEffigy>();
    }
}
