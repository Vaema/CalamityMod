...
{
    public class CalamityCanvas2023Tile : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            if (cube != null)
            {
                ...
                Main.LocalPlayer.Calamity().CurrentlyViewedCanvasType = 0;
        ...
        {
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<Items.Placeables.Furniture.CalamityCanvas2023>();
        ...
        public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (cube != null && t.TileFrameX == 0)
            {
                ...
                // TODO: make the 0.4 in scale not a hardcoded number with seemingly no meaning
                spriteBatch.Draw(texture, pos - Main.screenPosition, new Rectangle(fPX, fPY, scale, scale), Lighting.GetColor(i, j), 0, new Vector2(0, 0), 1 / cube.scale * 0.4f, 0, 0);
                spriteBatch.End();
        ...
        public static void DrawBorders(SpriteBatch spriteBatch, Vector2 pos, Point cords)
        {
            ...
            ushort canvasID = (ushort)ModContent.TileType<CalamityCanvas2023Tile>();
            int commonDim = 8;
            int finalCord = 72;
            int size = 80;
