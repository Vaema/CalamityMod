...
namespace CalamityMod.Tiles.Furniture
{
    public class ThaumaticChairTile : ModTile
    {
        ...
        {
            Dust.NewDust(new Vector2(i, j) * 16f, 16, 16, DustID.WoodFurniture, 0f, 0f, 1, default, 1f);
            return false;
        }
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.ChairMouseOver(i, j, ModContent.ItemType<ThaumaticChair>());
