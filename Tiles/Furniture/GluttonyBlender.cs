    ...
    public class GluttonyBlenderAnimation : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 1 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                // 0.1% per minute of duration, multiplied by 1.5x for T2 food and 2x for T3 food
                float goodPercent = dummy.buffTime * (dummy.buffType == BuffID.WellFed3 ? 2f : dummy.buffType == BuffID.WellFed2 ? 1.5f : 1f) / 3600f / 10f;
