...
namespace CalamityMod.Tiles.FurnitureDriftwood
{
    ...
    {
        public override void SetStaticDefaults() => this.SetUpChair(ModContent.ItemType<Items.Placeables.FurnitureDriftwood.DriftwoodChair>(), true);
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureDriftwood.DriftwoodChair>());
