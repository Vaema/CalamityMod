...
{
    public class DriftwoodToilet : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureDriftwood.DriftwoodToilet>());
