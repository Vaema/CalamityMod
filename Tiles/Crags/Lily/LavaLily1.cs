...
namespace CalamityMod.Tiles.Crags.Lily
{
    public class LavaLily1 : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            GlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily1Glow");
            ...
            {
                TopTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily1Top");
                TopGlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily1TopGlow");

                DrawLilyTop(i, j, TopTexture.Value, new Rectangle(0, 0, 178, 184), TileOffset.ToWorldCoordinates(), new Vector2(98, 191), false);
                DrawLilyTop(i, j, TopGlowTexture.Value, new Rectangle(0, 0, 178, 184), TileOffset.ToWorldCoordinates(), new Vector2(98, 191), true);
            }
        }
    }
}
