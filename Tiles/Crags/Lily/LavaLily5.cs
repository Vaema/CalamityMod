...
public class LavaLily5 : ModTile
{
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        GlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily5Glow");
        ...
        {
            TopTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily5Top");
            TopGlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily5TopGlow");

            DrawLilyTop(i, j, TopTexture.Value, new Rectangle(0, 0, 192, 206), TileOffset.ToWorldCoordinates(), new Vector2(118, 209), false);
            DrawLilyTop(i, j, TopGlowTexture.Value, new Rectangle(0, 0, 192, 206), TileOffset.ToWorldCoordinates(), new Vector2(118, 209), true);
        }
    }
}
