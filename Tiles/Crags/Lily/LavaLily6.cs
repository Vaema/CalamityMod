...
public class LavaLily6 : ModTile
{
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        GlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily6Glow");
        ...
        {
            TopTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily6Top");
            TopGlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/Crags/Lily/LavaLily6TopGlow");

            DrawLilyTop(i, j, TopTexture.Value, new Rectangle(0, 0, 178, 198), TileOffset.ToWorldCoordinates(), new Vector2(96, 199), false);
            DrawLilyTop(i, j, TopGlowTexture.Value, new Rectangle(0, 0, 178, 198), TileOffset.ToWorldCoordinates(), new Vector2(96, 199), true);
        }
    }
}
