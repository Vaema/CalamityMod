...
namespace CalamityMod.Tiles.FurnitureOtherworldly
{
    ...
    public class OtherworldlyChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurnitureOtherworldly.OtherworldlyChest>(), FurnitureCommon.GetMapChestName);
        }
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.ChestMouseOver<Items.Placeables.FurnitureOtherworldly.OtherworldlyChest>(i, j);
        public override void MouseOverFar(int i, int j) => FurnitureCommon.ChestMouseFar<Items.Placeables.FurnitureOtherworldly.OtherworldlyChest>(i, j);
