...
namespace CalamityMod.Tiles.FurnitureOtherworldly
{
    ...
    {
        public override void SetStaticDefaults() => this.SetUpChair(ModContent.ItemType<Items.Placeables.FurnitureOtherworldly.OtherworldlyChair>(), true);
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureOtherworldly.OtherworldlyChair>());
