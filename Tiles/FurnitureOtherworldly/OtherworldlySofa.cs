...
namespace CalamityMod.Tiles.FurnitureOtherworldly
{
    ...
    public class OtherworldlySofa : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureOtherworldly.OtherworldlySofa>());
