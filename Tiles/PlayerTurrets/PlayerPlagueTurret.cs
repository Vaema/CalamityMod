...
namespace CalamityMod.Tiles.PlayerTurrets
{
    public class PlayerPlagueTurret : ModTile
    {
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            TEPlayerPlagueTurret te = CalamityUtils.FindTileEntity<TEPlayerPlagueTurret>(i, j, Width, Height, SheetSquare);
            te?.Kill(left, top);
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            HeadTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/PlayerTurrets/PlagueTurretHead");
