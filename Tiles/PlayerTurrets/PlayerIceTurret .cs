...
{
    public class PlayerIceTurret : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ModTileEntity te = ModContent.GetInstance<TEPlayerIceTurret>();
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            TEPlayerIceTurret te = CalamityUtils.FindTileEntity<TEPlayerIceTurret>(i, j, Width, Height, SheetSquare);
            te?.Kill(left, top);
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            HeadTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/PlayerTurrets/IceTurretHead");
