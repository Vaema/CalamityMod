...
public class StratusDoorClosed : ModTile
{
    ...
    {
        this.SetUpDoorClosed(ModContent.ItemType<Items.Placeables.FurnitureStratus.StratusDoor>(), true);
        TileID.Sets.OpenDoorID[Type] = ModContent.TileType<StratusDoorOpen>();
    }
