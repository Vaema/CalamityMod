...
namespace CalamityMod.Tiles.FurnitureStratus
{
    public class StratusDresser : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurnitureStratus.StratusDresser>(), FurnitureCommon.GetMapChestName);
        }
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.DresserMouseOver<Items.Placeables.FurnitureStratus.StratusDresser>();
        public override void MouseOverFar(int i, int j) => FurnitureCommon.DresserMouseFar<Items.Placeables.FurnitureStratus.StratusDresser>();
