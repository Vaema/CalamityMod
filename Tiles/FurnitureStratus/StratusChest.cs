...
public class StratusChest : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurnitureStratus.StratusChest>(), FurnitureCommon.GetMapChestName);
    }
    ...
    public override void MouseOver(int i, int j) => FurnitureCommon.ChestMouseOver<Items.Placeables.FurnitureStratus.StratusChest>(i, j);
    public override void MouseOverFar(int i, int j) => FurnitureCommon.ChestMouseFar<Items.Placeables.FurnitureStratus.StratusChest>(i, j);
