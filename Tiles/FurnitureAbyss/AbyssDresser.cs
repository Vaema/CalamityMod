...
namespace CalamityMod.Tiles.FurnitureAbyss
{
    public class AbyssDresser : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(191, 142, 111), CalamityUtils.GetItemName<Items.Placeables.FurnitureAbyss.AbyssDresser>(), FurnitureCommon.GetMapChestName);
        }
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.DresserMouseOver<Items.Placeables.FurnitureAbyss.AbyssDresser>();
        public override void MouseOverFar(int i, int j) => FurnitureCommon.DresserMouseFar<Items.Placeables.FurnitureAbyss.AbyssDresser>();
