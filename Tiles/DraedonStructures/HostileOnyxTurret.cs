...
{
    public class HostileOnyxTurret : ModTile
    {
        ...
        public override string Texture => "CalamityMod/Tiles/PlayerTurrets/PlayerOnyxTurret";
        public override void SetStaticDefaults()
        {
            ...
            ModTileEntity te = ModContent.GetInstance<TEHostileOnyxTurret>();
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            TEHostileOnyxTurret te = CalamityUtils.FindTileEntity<TEHostileOnyxTurret>(i, j, Width, Height, SheetSquare);
            te?.Kill(left, top);
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            GlowTexture ??= ModContent.Request<Texture2D>("CalamityMod/Tiles/PlayerTurrets/OnyxTurretHead");
