...
{
    public class HostileLaserTurret : ModTile
    {
        ...
        public override string Texture => "CalamityMod/Tiles/PlayerTurrets/PlayerLaserTurret";
        public override void SetStaticDefaults()
        {
            ...
            ModTileEntity te = ModContent.GetInstance<TEHostileLaserTurret>();
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            TEHostileLaserTurret te = CalamityUtils.FindTileEntity<TEHostileLaserTurret>(i, j, Width, Height, SheetSquare);
            te?.Kill(left, top);
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D tex = ModContent.Request<Texture2D>("CalamityMod/Tiles/PlayerTurrets/LaserTurretHead").Value;
