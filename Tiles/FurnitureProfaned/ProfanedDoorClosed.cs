...
public class ProfanedDoorClosed : ModTile
{
    ...
    {
        this.SetUpDoorClosed(ModContent.ItemType<Items.Placeables.FurnitureProfaned.ProfanedDoor>(), true);
        TileID.Sets.OpenDoorID[Type] = ModContent.TileType<ProfanedDoorOpen>();
    }
