...
public class SulphurousRib5Echo : ModTile
{
    public override string Texture => "CalamityMod/Tiles/Abyss/SulphurousRib5";
    public override void SetStaticDefaults()
    {
        ...
        FlexibleTileWand.RubblePlacementSmall.AddVariations(ModContent.ItemType<CorrodedFossil>(), Type, 0);
