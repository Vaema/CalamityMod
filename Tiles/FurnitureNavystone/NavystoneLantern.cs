...
public class NavystoneLantern : ModTile
{
    public override void SetStaticDefaults() => this.SetUpLantern(ModContent.ItemType<Items.Placeables.FurnitureNavystone.NavystoneLantern>());
