...
namespace CalamityMod.Tiles.FurnitureNavystone.FurnitureAncientNavystone
{
    ...
    public class AncientNavystoneLamp : ModTile
    {
        public override void SetStaticDefaults() => this.SetUpLamp(ModContent.ItemType<Items.Placeables.FurnitureNavystone.FurnitureAncientNavystone.AncientNavystoneLamp>());
