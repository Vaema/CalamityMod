...
namespace CalamityMod.Tiles.FurnitureNavystone.FurnitureAncientNavystone
{
    ...
    public class AncientNavystoneClock : ModTile
    {
        public override void SetStaticDefaults() => this.SetUpClock(ModContent.ItemType<Items.Placeables.FurnitureNavystone.FurnitureAncientNavystone.AncientNavystoneClock>());
