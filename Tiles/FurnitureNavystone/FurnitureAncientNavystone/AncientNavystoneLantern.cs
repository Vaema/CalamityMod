...
namespace CalamityMod.Tiles.FurnitureNavystone.FurnitureAncientNavystone
{
    ...
    public class AncientNavystoneLantern : ModTile
    {
        public override void SetStaticDefaults() => this.SetUpLantern(ModContent.ItemType<Items.Placeables.FurnitureNavystone.FurnitureAncientNavystone.AncientNavystoneLantern>());
