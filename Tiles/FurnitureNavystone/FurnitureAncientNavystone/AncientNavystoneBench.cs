...
namespace CalamityMod.Tiles.FurnitureNavystone.FurnitureAncientNavystone
{
    ...
    public class AncientNavystoneBench : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.BenchMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureNavystone.FurnitureAncientNavystone.AncientNavystoneBench>());
