...
namespace CalamityMod.Tiles.FurnitureNavystone.FurnitureAncientNavystone
{
    ...
    public class AncientNavystoneChair : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureNavystone.FurnitureAncientNavystone.AncientNavystoneChair>());
