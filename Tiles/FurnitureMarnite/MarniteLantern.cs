...
{
    public class MarniteLantern : ModTile
    {
        public override void SetStaticDefaults() => this.SetUpLantern(ModContent.ItemType<Items.Placeables.FurnitureMarnite.MarniteLantern>(), true);
