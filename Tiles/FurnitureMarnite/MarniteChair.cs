...
public class MarniteChair : ModTile
{
    public override void SetStaticDefaults() => this.SetUpChair(ModContent.ItemType<Items.Placeables.FurnitureMarnite.MarniteChair>(), true);
    ...
    public override void MouseOver(int i, int j) => FurnitureCommon.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureMarnite.MarniteChair>());
