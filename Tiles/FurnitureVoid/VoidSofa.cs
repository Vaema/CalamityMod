...
namespace CalamityMod.Tiles.FurnitureVoid
{
    ...
    {
        public override void SetStaticDefaults() => this.SetUpSofa(ModContent.ItemType<Items.Placeables.FurnitureVoid.VoidSofa>(), true);
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureVoid.VoidSofa>());
