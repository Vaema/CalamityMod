...
namespace CalamityMod.Tiles.FurnitureWulfrum.FurnitureAnodizedWulfrum
{
    public class AnodizedWulfrumToilet : ModTile
    {
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureWulfrum.FurnitureAnodizedWulfrum.AnodizedWulfrumToilet>());
