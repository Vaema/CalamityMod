...
public class AncientDoorClosed : ModTile
{
    ...
    {
        this.SetUpDoorClosed(ModContent.ItemType<Items.Placeables.FurnitureAncient.AncientDoor>(), true);
        TileID.Sets.OpenDoorID[Type] = ModContent.TileType<AncientDoorOpen>();
    }
