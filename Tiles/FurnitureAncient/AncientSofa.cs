...
namespace CalamityMod.Tiles.FurnitureAncient
{
    ...
    {
        public override void SetStaticDefaults() => this.SetUpSofa(ModContent.ItemType<Items.Placeables.FurnitureAncient.AncientSofa>(), true);
        ...
        public override void MouseOver(int i, int j) => FurnitureCommon.BenchMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureAncient.AncientSofa>());
