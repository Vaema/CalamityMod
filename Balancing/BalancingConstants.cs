namespace CalamityMod.Balancing
{
    public static class BalancingConstants
    {
        ...
        // When the relevant config is enabled: Increases the player's base jump speed by 14.37% (allows you to jump 7 blocks)
        internal static readonly float ConfigBoostedBaseJumpSpeed = 5.73f; // vanilla = 5.01f
