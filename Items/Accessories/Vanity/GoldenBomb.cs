...
{
    public class GoldenBomb : ModItem, ILocalizedModType
    {
        ...
        public override void Load()
        {
            if (!Main.dedServ)
            {
                EquipLoader.AddEquipTexture(Mod, "CalamityMod/Items/Accessories/Vanity/Mihaii_Head", EquipType.Head, this);
                EquipLoader.AddEquipTexture(Mod, "CalamityMod/Items/Accessories/Vanity/Mihaii_Body", EquipType.Body, this);
                EquipLoader.AddEquipTexture(Mod, "CalamityMod/Items/Accessories/Vanity/Mihaii_Legs", EquipType.Legs, this);
            }
        }
        ...
        {
            player.GetModPlayer<GoldenBombPlayer>().vanityEquipped = true;
        }
    ...
    public class GoldenBombPlayer : ModPlayer
    {
