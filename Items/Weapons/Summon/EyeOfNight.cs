...
namespace CalamityMod.Items.Weapons.Summon
{
    public class EyeOfNight : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.buffType = ModContent.BuffType<EyeOfNightBuff>();
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            var minion = Projectile.NewProjectileDirect(source, player.ClampedMouseWorld(), Vector2.UnitY * -3f, type, damage, knockback, player.whoAmI);
