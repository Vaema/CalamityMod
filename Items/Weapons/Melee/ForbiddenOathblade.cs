...
namespace CalamityMod.Items.Weapons.Melee
{
    public class ForbiddenOathblade : ModItem, ILocalizedModType
    {
        ...
        public override void HoldItem(Player player)
        {
            ...
            if (player.Calamity().mouseRight && player.Calamity().killModeCooldown == 0)
            {
            ...
            {
                Projectile blade = Projectile.NewProjectileDirect(player.GetSource_FromThis(), player.MountedCenter,Vector2.Zero, ModContent.ProjectileType<ForbiddenOathbladeHoldout>(), Item.damage * 10, Item.knockBack, player.whoAmI, 0, throwCount);
            }
        }
