...
namespace CalamityMod.Items.Weapons.Ranged
{
    public class Leviatitan : ModItem, ILocalizedModType
    {
        ...
        {
            Projectile holdout = Projectile.NewProjectileDirect(source, player.MountedCenter, Vector2.Zero, ModContent.ProjectileType<LeviatitanHoldout>(), damage, knockback, player.whoAmI);
