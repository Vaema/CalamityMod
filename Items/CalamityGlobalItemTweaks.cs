    ...
    public partial class CalamityGlobalItem : GlobalItem
    {
        ...
        internal static void LoadTweaks()
        {
            ...
            currentTweaks = new SortedDictionary<int, IItemTweak[]>
            {
                ...
                { ItemID.AdamantiteGlaive, Do(AutoReuse, TrueMelee, UseExact(6), ShootSpeedExact(18f)) },
                { ItemID.AdamantiteRepeater, Do(PointBlank, UseExact(14)) },
                { ItemID.AdamantiteSword, Do(UseTurn, UseExact(6)) },
                ...
                { ItemID.CobaltNaginata, Do(AutoReuse, TrueMelee, UseExact(9), ShootSpeedExact(12f)) },
                { ItemID.CobaltRepeater, Do(PointBlank, UseExact(18)) },
                { ItemID.CobaltSword, Do(UseTurn, UseExact(9)) },
                ...
                { ItemID.MythrilHalberd, Do(AutoReuse, TrueMelee, UseExact(8), ShootSpeedExact(14f)) },
                { ItemID.MythrilRepeater, Do(PointBlank, UseExact(16)) },
                { ItemID.MythrilSword, Do(UseTurn, UseExact(8)) },
                ...
                { ItemID.OrichalcumHalberd, Do(AutoReuse, TrueMelee, DamageExact(120), ShootSpeedRatio(1.25f)) },
                { ItemID.OrichalcumRepeater, Do(PointBlank, DamageExact(48)) },
                { ItemID.OrichalcumSword, Do(UseTurn, DamageExact(144)) },
                { ItemID.PainterPaintballGun, Do(PointBlank, DamageExact(8)) },
                { ItemID.PaladinsHammer, Do(DamageExact(100), ShootSpeedExact(23)) },
                { ItemID.PalladiumPike, Do(AutoReuse, TrueMelee, DamageExact(96)) },
                { ItemID.PalladiumRepeater, Do(PointBlank, DamageExact(45)) },
                { ItemID.PalladiumSword, Do(UseTurn, DamageExact(120)) },
                { ItemID.PearlwoodBow, Do(AutoReuse, PointBlank, DamageExact(32)) },
                ...
                { ItemID.TitaniumSword, Do(UseTurn, DamageExact(180)) },
                { ItemID.TitaniumTrident, Do(AutoReuse, TrueMelee, DamageExact(132), ShootSpeedRatio(1.25f)) },
