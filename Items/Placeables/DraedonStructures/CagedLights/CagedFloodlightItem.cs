...
public class CagedFloodlightItem : ModItem, ILocalizedModType
{
    public new string LocalizationCategory => "Items.Placeables";
    public override void SetDefaults()
    {
        ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<AgedFloodlightItem>();

        Item.DefaultToPlaceableTile(ModContent.TileType<CagedFloodlight>());
