...
{
    public class RustedPlatePillar : ModItem, ILocalizedModType
    {
        ...
        public override void SetDefaults() => Item.DefaultToPlaceableWall(ModContent.WallType<WallTiles.RustedPlatePillar>());
