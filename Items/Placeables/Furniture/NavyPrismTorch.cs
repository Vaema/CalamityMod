...
public class NavyPrismTorch : ModItem, ILocalizedModType
{
    ...
    {
        Lighting.AddLight((int)((Item.position.X + Item.width / 2) / 16f), (int)((Item.position.Y + Item.height / 2) / 16f), 0.8f, 1.2f, 1.2f);
    }
