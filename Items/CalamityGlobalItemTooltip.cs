...
namespace CalamityMod.Items
{
    public partial class CalamityGlobalItem : GlobalItem
    {
        ...
        {
            if (line.Name == "ItemName" && line.Mod == "Terraria" && item.type == ModContent.ItemType<XyksBlessingBlue>() && !CalamityClientConfig.Instance.Photosensitivity)
            {
            ...
            if (line.Name == "ItemName" && line.Mod == "Terraria" && item.type == ModContent.ItemType<XyksBlessingOrange>() && !CalamityClientConfig.Instance.Photosensitivity)
            {
                Color rarityColor = Color.White;
                Vector2 basePosition = new Vector2(line.X, line.Y);
