...
namespace CalamityMod.NPCs.ExoMechs.Ares
{
    ...
    public class AresBody : ModNPC
    {
        ...
        public static void DefineExoMechLoot(NPC npc, NPCLoot npcLoot, int mechType)
        {
            ...
            // Legendary seed soup
            mainDrops.Add(ItemDropRule.ByCondition(DropHelper.If(info => info.npc.type == ModContent.NPCType<AresBody>() && info.npc.ModNPC<Ares.AresBody>().exoMechdusa), ModContent.ItemType<PotofPain>()), hideLootReport: true);
