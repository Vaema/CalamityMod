...
namespace CalamityMod.NPCs.Providence
{
    ...
    public class ProvSpawnOffense : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            NPC.DrawBackglow(ProvUtils.GetColorBasedOnEnrage(0, true), 4f, spriteEffects, NPC.frame, Main.screenPosition, texture2D15);

            spriteBatch.Draw(texture2D15, drawLocation, NPC.frame, ProvUtils.GetColorBasedOnEnrage(0), NPC.rotation, halfSizeTexture, NPC.scale, spriteEffects, 0f);
