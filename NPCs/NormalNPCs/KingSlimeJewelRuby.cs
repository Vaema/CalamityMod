    ...
    public class KingSlimeJewelRuby : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] >= (BossRushEvent.BossRushActive ? BoltShootGateValue_BossRush : CalamityWorld.death ? BoltShootGateValue_Death : BoltShootGateValue))
            {
                ...
                SoundEngine.PlaySound(ShatterSound.WithPitchOffset(-0.75f).WithVolumeScale(0.4f), NPC.Center);
        ...
        public override void OnKill()
        {
            ...
            {
                GeneralParticleHandler.SpawnParticle(new PointParticle(NPC.Center, new Vector2(Main.rand.NextFloat(20), 0).RotatedByRandom(MathHelper.TwoPi), false, 10, Main.rand.NextFloat(0.5f, 1.5f), Color.Red));
                GeneralParticleHandler.SpawnParticle(new PointParticle(NPC.Center, new Vector2(Main.rand.NextFloat(10), 0).RotatedByRandom(MathHelper.TwoPi), false, 10, Main.rand.NextFloat(0.5f, 1.5f), Color.HotPink));
            }
