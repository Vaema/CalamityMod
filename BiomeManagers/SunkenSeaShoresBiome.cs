...
namespace CalamityMod.BiomeManagers
{
    ...
    {
        public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("CalamityMod/SunkenSeaShoresWater");
        ...
        {
            return BiomeTileCounterSystem.SunkenSeaShoresTiles > 1000;
        }
    }
}
